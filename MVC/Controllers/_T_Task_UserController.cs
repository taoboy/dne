...
{
    public partial class _T_Task_UserController : ControllerBase
    {
        T_Task_UserDAO entityDao = new T_Task_UserDAO();
        ...
        public ActionResult List()
        {
            ...
            //Dictionary<T_Task_UserColumns, AscDesc> orderBy = new Dictionary<T_Task_UserColumns, AscDesc>();
            //List<T_Task_User> entitys = entityDao.WebSearch(page, this.pageSize, search_criteria, orderBy, out total);

            T_Task_User entity = new T_Task_User();	
            List<T_Task_User> entitys = 
			entityDao.Search(entity, page, this.pageSize,search_criteria,T_Task_User.Columns.id, AscDesc.ASC, out total);
        ...
        public JsonResult Update(T_Task_User entity) {
		...
		[ValidateInput(false)]//要加上这一句，否则会造成富文本里面的HTML代码危险警报
        public JsonResult Add(T_Task_User entity) {
